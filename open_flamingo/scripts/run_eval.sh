...
COCO_IMG_PATH="/mscoco/train2017/"
COCO_ANNO_PATH="/mscoco/annotations/captions_train2017.json"
VQAV2_IMG_PATH="/vqav2/train2014"
VQAV2_ANNO_PATH="/vqav2/v2_mscoco_train2014_annotations.json"
VQAV2_QUESTION_PATH="/vqav2/v2_OpenEnded_mscoco_train2014_questions.json"
